...
<div class="card" style="width: 18rem;">
  <img src="kelas/<?php echo $value['f_nama']; ?>.jpg" class="card-img-top" alt="KELAS">
  <div class="card-body">
    <h5 class="card-title">
...
<div class="col-md-4 mb-5">
<div class="card" style="width: 18rem;">
  <img src="guru/<?php echo $value['f_nama']; ?>.jpg" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">
...
<!-- Akhir table -->
    ...
    <footer class="bg-primary text-white text-center pb-3">
        <p>Created with <i class="bi bi-heart-fill text-danger"></i> by
            <a href="https://www.tiktok.com/@michaelpoetrasetyadjie?is_from_webapp=1&sender_device=pcx" class="text-white fw-bold">ps22michael</a> </a>
        </p>
    </footer>
